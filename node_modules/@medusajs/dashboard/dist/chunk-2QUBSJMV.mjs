          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-BGBZJ5WX.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-VKZ46X6T.mjs")
                    },
                    {
                      path: "import",
                    ...
                    {
                      path: "export",
                      lazy: () => import("./product-export-KJXAVIZ3.mjs")
                    }
                  ]
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-CQX65Z5E.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-CQX65Z5E.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-FMUOE3JV.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-5L64AKRQ.mjs")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-JBZ5SBZP.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-KWWBOSL2.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-6NRWT27C.mjs")
                        },
                        {
                          path: "media",
                    ...
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./product-variant-detail-HKNUYNS5.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-BKFYUODS.mjs")
                        },
                        {
                          path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-OWRWVUVN.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./category-detail-WTSUKIXM.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "products",
                      lazy: () => import("./category-products-CRKFES6N.mjs")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-HUXXVJAB.mjs")
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-D4WMVRA2.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./order-detail-RP63TRG6.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      lazy: () => import("./order-create-shipment-REC24C7Y.mjs")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-CDCLNOCB.mjs")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-JRJNBW7N.mjs")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-SWV6T3C2.mjs")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-IYZYZOJU.mjs")
                    },
                    {
                      path: "refund",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-SXMDW6B6.mjs"),
                  children: []
                },
                {
                  path: "create",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-G5PTIE4I.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./collection-detail-XRN3Y3YT.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-XERJQKAX.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-C53HAXU7.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-7HYQ5R7R.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./price-list-detail-DWUY4NRM.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-QDADAJXD.mjs")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-PGOF7G5W.mjs")
                    },
                    {
                      path: "products/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-3LZRV3ZM.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-detail-EW4Y5ZHT.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      lazy: () => import("./customers-add-customer-group-F473JGOA.mjs")
                    },
                    {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-ZYLGQKOU.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./customer-group-detail-WZFJPKZE.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-UJJ77G7K.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-NAYFTRNY.mjs"),
                  children: [
                    {
                      path: "create",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-XIL665KR.mjs"),
                  children: [
                    {
                      path: "create",
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-4HQ3RK2U.mjs"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-VZPQ4NSH.mjs")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-F7I4UPZS.mjs"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-NQLVPGUT.mjs")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./region-detail-BBK4KAZ5.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-DGMSV27N.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              path: "store",
              errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
              lazy: () => import("./store-detail-U5HON77R.mjs"),
              handle: {
              ...
              children: [
                ...
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-2OBWTWKT.mjs")
                },
                {
                  path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-35TJ53CP.mjs"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-3V3ZTOJS.mjs")
                    }
                  ]
                },
                {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-2EDYVY5Y.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-UFL3EW5W.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-ACYP5CUR.mjs")
                    },
                    {
                      path: "metadata/edit",
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-EFGYH4OS.mjs"),
                      children: [
                        {
                          path: "create",
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-JODORWDG.mjs")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-ELVN5G5W.mjs")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-6DZFP7Y7.mjs")
                        },
                        {
                          ...
                          children: [
                            ...
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-EJIOVS3U.mjs")
                            },
                            {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-DASW6YQO.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-tag-detail-LQFUS6IU.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-FKIKX7HK.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-A36X6L73.mjs"),
                  children: [
                    {
                      path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./product-type-detail-VLOGXH6T.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-XQ5M7CMJ.mjs"),
                      children: [
                        {
                          path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-QVWVJ5X6.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-PILAZSU6.mjs")
                    }
                  ]
                }
              ]
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          lazy: () => import("./tax-region-tax-override-create-EXGXVKBR.mjs")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-2T7PD6N3.mjs")
                        },
                        {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-YQP7NEIY.mjs"),
                  children: [
                    {
                      path: "create",
