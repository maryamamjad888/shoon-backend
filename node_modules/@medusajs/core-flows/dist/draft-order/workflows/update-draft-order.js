...
exports.updateDraftOrderWorkflow = exports.updateDraftOrderWorkflowId = void 0;
...
const updateDraftOrderStep = (0, workflows_sdk_1.createStep)("update-draft-order", async ({ order, input }, { container }) => {
