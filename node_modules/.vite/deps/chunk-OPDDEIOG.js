import {
  ...
  taxRegionLoader
} from "./chunk-XTUBI7HC.js";
import {
  isFetchError
} from "./chunk-GDY5GCSF.js";
import {
  useReturnReasons
} from "./chunk-OCQCFK6H.js";
import {
  ProgressBar
...
import {
  FilePreview
} from "./chunk-KYRT4F5Z.js";
import {
  ConditionalTooltip
} from "./chunk-GEABDW7Z.js";
import {
  we
} from "./chunk-RAJ42U22.js";
import {
  languages
} from "./chunk-LBNYM3GN.js";
import {
  formatDistance
...
import {
  useApiKeys
} from "./chunk-UGKAV6OK.js";
import {
  useTaxRegions
} from "./chunk-2KBC7L4Y.js";
import {
  useProductTypes
} from "./chunk-TG6GNXKT.js";
import {
  useShippingProfiles
} from "./chunk-L2CW3JNT.js";
import {
  useMe,
  useUsers
} from "./chunk-PN75AFAY.js";
import {
  usePriceLists
...
import {
  useOrders
} from "./chunk-HI27CA54.js";
import {
  useProductCategories
} from "./chunk-TKTW6E4H.js";
import {
  useStore
} from "./chunk-ZCCGJOHC.js";
import {
  useRegions
...
// node_modules/@medusajs/dashboard/dist/chunk-2QUBSJMV.mjs
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-BGBZJ5WX-AIIJYRIX.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-VKZ46X6T-XXPG4Z5D.js")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-JCEJKM3F-ZIWADPT7.js")
                    },
                    {
                      path: "export",
                      lazy: () => import("./product-export-KJXAVIZ3-N2N3SYLU.js")
                    }
                  ]
                },
                {
                  ...
                  errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-CQX65Z5E-FU3VJZXC.js");
                    return {
                      Component: Outlet,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-CQX65Z5E-FU3VJZXC.js"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-FMUOE3JV-BQVI5VT3.js")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-G6AM27AT-LFH4H32O.js")
                        },
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-5L64AKRQ-E7KUVBFU.js")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-JBZ5SBZP-6OZYZVB5.js")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-KWWBOSL2-CZRVVJC3.js")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-6NRWT27C-HB6DZUBN.js")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-34NDO6DC-PLOX4KMW.js")
                        },
                        {
                          path: "prices",
                          lazy: () => import("./product-prices-BBTCM3XR-FOGTUGL3.js")
                        },
                        {
                          path: "options/create",
                          lazy: () => import("./product-create-option-E2GRTBWP-QUUEQFWD.js")
                        },
                        {
                          path: "options/:option_id/edit",
                          lazy: () => import("./product-edit-option-RHMF3YKT-OFUROQQQ.js")
                        },
                        {
                          path: "variants/create",
                          lazy: () => import("./product-create-variant-3B32EC76-7XUOLKAU.js")
                        },
                        {
                          path: "stock",
                          lazy: () => import("./product-stock-TZS75EG7-3NZFBRVG.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-metadata-PQQ7XV63-KJUDPNPL.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-HKNUYNS5-RTZULPDL.js");
                        return {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-BKFYUODS-C2LN3KRX.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-variant-metadata-2V27ZMDS-JTIM7OWA.js")
                        }
                      ]
                    }
                  ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-OWRWVUVN-MJYUVWPE.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./category-create-NVRG7B6E-VSC7B3QL.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-HUXXVJAB-YFCRT7OW.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-WTSUKIXM-ZT3ER632.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./category-edit-JBZQKNL7-UFT3DVRQ.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./category-products-CRKFES6N-AEPDW76K.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-HUXXVJAB-YFCRT7OW.js")
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./categories-metadata-TE7B2OJY-6NRPRD4B.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-D4WMVRA2-YQ5GLSII.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-RP63TRG6-NEOOBJO7.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-62OZHL3L-OKSBYXRJ.js")
                    },
                    {
                      path: "returns/:return_id/receive",
                      lazy: () => import("./order-receive-return-AXAZNUIB-3TYYCWQQ.js")
                    },
                    {
                      path: "allocate-items",
                      lazy: () => import("./order-allocate-items-TMQ5M7TG-ZLO7CNXW.js")
                    },
                    {
                      path: ":f_id/create-shipment",
                      lazy: () => import("./order-create-shipment-REC24C7Y-HWL3GSHH.js")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-CDCLNOCB-62KYAKJJ.js")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-JRJNBW7N-QJPHN3XL.js")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-SWV6T3C2-HZIBFQK4.js")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-IYZYZOJU-K66XAIIJ.js")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-FXUURAS7-WF4HGJTO.js")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-OZNQQL3N-5ENBZZUI.js")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-V4DC4GJV-UYOGI6WD.js")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-NWT5LDKC-Q4FUS6VQ.js")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-XDNORAHG-S725PVG2.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./order-metadata-4YNV2NWH-K6RGXAUE.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-AGVOXS5Q-5KTLUCIS.js")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-PLDWDZMZ-6WDXOEVM.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-DKYNPGDK-XHKZZZSI.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./promotion-edit-details-D6M646E6-CHABK7H6.js")
                    },
                    {
                      path: "add-to-campaign",
                      lazy: () => import("./promotion-add-campaign-4VNRQF52-SYEKZQ6M.js")
                    },
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-7MMNZKEQ-JCDM5B3J.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-SXMDW6B6-NA3IQ2E5.js"),
                  children: []
                },
                {
                  path: "create",
                  lazy: () => import("./campaign-create-NYJ4HILG-ILPEFLB6.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-ITINMJJH-UJHXGBUK.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./campaign-edit-3D5WFWCT-X5DLARZR.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./campaign-configuration-QV3OHWBZ-PHLFUEAZ.js")
                    },
                    {
                      path: "edit-budget",
                      lazy: () => import("./campaign-budget-edit-57NSOYJ3-P56BEGNJ.js")
                    },
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-ZVOK5XD2-GP2HKQRH.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-G5PTIE4I-VKWIHMZ5.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./collection-create-PXO6DJS3-VTGJL27J.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-XRN3Y3YT-GDWVJPTP.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./collection-edit-D7OGD4MC-WPHRRSU6.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-XERJQKAX-2GUEJ52A.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./collection-metadata-244B7424-XZ7LKAOE.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-C53HAXU7-IMUURI7E.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-7HYQ5R7R-BHFBPMGU.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-DWUY4NRM-OPWPWSEC.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./price-list-edit-TMZCXEFR-TREYX77K.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-QDADAJXD-BQLHHLBW.js")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-PGOF7G5W-7C45Q2JL.js")
                    },
                    {
                      path: "products/edit",
                      lazy: () => import("./price-list-prices-edit-JUS5FBBN-KJN6C4UE.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-3LZRV3ZM-ZO2NILBD.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-create-TKKVS4LF-FS55PEFX.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-EW4Y5ZHT-AOF2E4MS.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-edit-I4K3LK66-J36J2CJF.js")
                    },
                    {
                      path: "create-address",
                      lazy: () => import("./customer-create-address-P4YQFUI5-H6PXQLED.js")
                    },
                    {
                      path: "add-customer-groups",
                      lazy: () => import("./customers-add-customer-group-F473JGOA-BR7W2XHH.js")
                    },
                    {
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-metadata-TPIFKFIQ-YVFSS7O3.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-ZYLGQKOU-JBVK3FLE.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-group-create-5EILGGLH-FCBSR6IA.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-WZFJPKZE-B2XGPCJP.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-group-edit-NBVNSBMX-OFSNWHMP.js")
                    },
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-UJJ77G7K-4SPFFK77.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-group-metadata-IRTI56TA-LWN6LPCI.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-NAYFTRNY-U7H5PEQO.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-INUIVD55-BZN6RW55.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-QKUCAH7D-VPGZPDZF.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-reservation-GEJHV6OI-IFZLLVH4.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./reservation-metadata-5ZABNMJP-3EKLLEZK.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-XIL665KR-XI3YD24O.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./inventory-create-NZ67QMNB-PNOD6INF.js")
                    },
                    {
                      path: "stock",
                      lazy: () => import("./inventory-stock-XZWLARFE-ORIIP4P3.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-UBCCADB3-L6OZ76HD.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-inventory-item-KQUKSOGO-4IJDNEZP.js")
                    },
                    {
                      path: "attributes",
                      lazy: () => import("./edit-inventory-item-attributes-I55BRBWC-72LJ2KQR.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./inventory-metadata-AG5IVFBR-33GPEEC4.js")
                    },
                    {
                      path: "locations",
                      lazy: () => import("./manage-locations-E7YAZVH2-B6T2ZGFB.js")
                    },
                    {
                      path: "locations/:location_id",
                      lazy: () => import("./adjust-inventory-WYNH75F7-T3QDO7WK.js")
                    }
                  ]
                }
              ]
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-4HQ3RK2U-ZNGVLC62.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-VZPQ4NSH-5U2O2RUB.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-F7I4UPZS-I5D7VF4W.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-NQLVPGUT-FHPT3NMX.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-BBK4KAZ5-NEVCMGV2.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-PXIMLBFB-7YIALZG4.js")
                    },
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-DGMSV27N-YZIWIZYR.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./region-metadata-4S6FEUXA-UAPLKHNR.js")
                    }
                  ]
                }
              ]
            },
            {
              path: "store",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./store-detail-U5HON77R-2GXX3HZP.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-JNSWFWIG-LPS2YVDS.js")
                },
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-2OBWTWKT-KWMK22GI.js")
                },
                {
                  path: "metadata/edit",
                  lazy: () => import("./store-metadata-GLAZZPP6-JFNBJEJ5.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-35TJ53CP-3UT3JFSK.js"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-3V3ZTOJS-CXPP2DET.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-X2Z2IYNI-KKNYE4LS.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./user-edit-HFSJM4QT-VSEZBCAP.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./user-metadata-GJ6PIXLU-UZGNV3HY.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-2EDYVY5Y-PBWA7KM6.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./sales-channel-create-HVZPII6E-H2NN4RNH.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-UFL3EW5W-T5ABIZNV.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./sales-channel-edit-BK7O3ZFI-KRPAASDF.js")
                    },
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-ACYP5CUR-WPRRH3JB.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./sales-channel-metadata-UH4QYASI-XOHJZAUR.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./location-list-5UJ6CSA7-24B3TGO2.js")
                },
                {
                  path: "create",
                  lazy: () => import("./location-create-G3CYBYOF-GVH4KMLV.js")
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-EFGYH4OS-KTZVJTFJ.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-profile-create-PBDONCGJ-ALEYQQZ4.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-EORJZ7NX-Y3R2MT3R.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "metadata/edit",
                          lazy: () => import("./shipping-profile-metadata-UB73OBPJ-GY2AG2L5.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":location_id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-GHY3DXRP-J74OMCKP.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./location-edit-IMBG32Z4-BVV6TRL6.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-JODORWDG-2R7RRGSU.js")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-ELVN5G5W-GG55QAVM.js")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-6DZFP7Y7-DAUEP2FA.js")
                        },
                        {
                          ...
                          children: [
                            {
                              path: "edit",
                              lazy: () => import("./location-service-zone-edit-W3G7XOC7-JCXLCFYC.js")
                            },
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-EJIOVS3U-A32C45XJ.js")
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-7KOH5VVW-AVS25ZR6.js")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-ODUEKZON-SQ76XVND.js")
                                    },
                                    {
                                      path: "pricing",
                                      lazy: () => import("./location-service-zone-shipping-option-pricing-SKUSE5YE-SLM4L2RN.js")
                                    }
                                  ]
                                }
                              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-DASW6YQO-AXU35JNT.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-tag-create-LE4MZ5BW-B5RKM6UP.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-LQFUS6IU-34FX4XUE.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-tag-edit-E6WEFNFQ-DBJK7B6J.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-FKIKX7HK-PGTH2YKT.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-D26MDYFC-B3TXHC57.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-A36X6L73-X66GOU2G.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-type-create-GU5IYXQB-P6JJDYTQ.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-VLOGXH6T-D6FUQTOX.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-type-edit-S53VUBU3-2NZPQFTN.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-type-metadata-P4ZKCJW5-EUWJJIPI.js")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-XQ5M7CMJ-6WICRHJX.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./api-key-management-create-HWBQGG6O-MVJO65CE.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-QVWVJ5X6-42BVH637.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./api-key-management-edit-UX47FHWV-CCLNSA44.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-PILAZSU6-WQDQRP2T.js")
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./tax-region-list-FNVPRMTQ-KHHJ5C2A.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-EW5USMNY-BUCSVRTW.js")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component: Component4 } = await import("./tax-region-detail-MVSV7BWW-3K6RACS6.js");
                        return {
                          Component: Component4
                        };
                      },
                      children: [
                        {
                          ...
                          lazy: () => import("./tax-region-province-create-LQ5SPSXW-J6VK4ZET.js")
                        },
                        {
                          path: "overrides/create",
                          lazy: () => import("./tax-region-tax-override-create-EXGXVKBR-FXXV6QZX.js")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-2T7PD6N3-2BGTZ2F6.js")
                        },
                        {
                          path: "tax-rates/create",
                          lazy: () => import("./tax-region-tax-rate-create-7GNLSDJ2-CSPHQOBO.js")
                        },
                        {
                          path: "tax-rates/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-rate-edit-6U2BQMIE-2XUVLT5R.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-4G2WUUBB-URTSDERA.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-YQP7NEIY-24CYDCCP.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./return-reason-create-YANSYS43-XJBKYYJE.js")
                    },
                    {
                      path: ":id",
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./return-reason-edit-4FSM4H3M-PN6NHBK3.js")
                        }
                      ]
                    }
                  ]
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-OYY6LIPR-MZQV46V5.js")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-HHFO6CDI-BEOTCM4W.js")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-3KXZ7ZZI-N2NVI6SE.js")
            },
            {
              path: "*",
              lazy: () => import("./no-match-YRNHGOT3-S3EBVP2O.js")
            }
          ]
        }
      ]
...
//# sourceMappingURL=chunk-OPDDEIOG.js.map
